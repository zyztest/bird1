    ...
    option = {
        ...
        xAxis: [
            {
                ...
                type: 'category',
                // 使用 data 中的数据设为刻度文字
                data: ['云南','四川','福建','广西','广东','湖北','浙江','北京','陕西','西藏','新疆','江西','江苏','湖南','甘肃','上海','贵州','河南','山东','重庆','河北','辽宁',
                '海南','青海','安徽','香港','内蒙古','台湾','山西','天津','吉林','宁夏','黑龙江','澳门'],
                // 刻度设置
                axisTick: {
                    // true意思：图形在刻度中间
                    // false意思：图形在刻度之间
        ...
        series: [

            {
                ...
                barWidth: '60%',
                // 数据
                data: [925, 679, 585, 584, 581,531,478,473,471,455,458,458,456,444,430,426,425,422,401,397,
                    391,385,374,373,361,358,352,305,305,274,229,215,215,29]
            }
        ],
        dataZoom: {
